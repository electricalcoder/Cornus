...
tc filter add dev eth0 protocol ip parent 1:0 prio 1 handle 1002 fw classid 1:1
tc filter add dev eth0 protocol ip parent 1:0 prio 1 handle 1001 fw classid 1:2
