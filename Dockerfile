...
RUN DEBIAN_FRONTEND=noninteractive apt update && DEBIAN_FRONTEND=noninteractive apt install -y vim git net-tools emacs python3 python3-pip wget curl sudo openssh-server rsync
